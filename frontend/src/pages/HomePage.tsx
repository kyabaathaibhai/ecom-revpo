        ...
        <div className='container-max section-padding relative'>
          <div className='text-center max-w-5xl mx-auto'>
            ...
            <p className='text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up stagger-2'>
              State-of-the-art biometric devices for enhanced security and
              seamless authentication. Experience the future of identity
              verification.
            </p>
        ...
        <div className='container-max'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Cutting-edge technology meets unparalleled security and user
              experience
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  'Advanced encryption and biometric algorithms ensure maximum protection for your data and identity.',
              ...
              },
              {
                ...
                description:
                  'Sub-second authentication with 99.9% accuracy rate. Experience seamless and instant verification.',
              ...
              },
              {
                ...
                description:
                  'Trusted by Fortune 500 companies worldwide. Award-winning technology with proven track record.',
      ...
      >
        <div className='container-max'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Discover our latest biometric devices designed for modern security
              needs
            </p>
          </div>
        ...
        <div className='container-max'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl mb-8 opacity-90'>
              Get the latest updates on new products, security insights, and
              industry trends
            </p>
